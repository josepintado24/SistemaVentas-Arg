...
class TemporalCompra extends BaseController{
	...
	public function inserta($id_producto, $cantidad,$id_compra){
		...
		if ($producto){
			...
			if ($datosExiste){
				...
				$this->temporal_compra->actualizarProductosCompra($id_producto, $id_compra, $cantidad, $subtotal);
			}else{
	...
	public function totalProductos($id_producto){
		$resultado=$this->temporal_compra->PorCompra($id_producto);
		...
		$datosExiste= $this->temporal_compra->porIdProductoCompra($id_producto,$id_compra);
			if ($datosExiste){
				...
				$this->temporal_compra->actualizarProductosCompra($id_producto, $id_compra, $cantidad, $subtotal);
					...
					$this->temporal_compra->eliminarProductosCompra($id_producto, $id_compra);
